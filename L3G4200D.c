...
void L3G4200D_WRITE_INT1_TSH_ZH1(u8 DATA)        ;
...
void L3G4200D_WRITE_INT1_TSH_ZH(u8 Threshold);
/*****************************************************************************************************/
                                         /* Local Symbols */
/*****************************************************************************************************/
/*Registers addresses*/
...
u8 GYHD_ReadYDirection(u16* pu16Data,u8* pu8ReadingStatus)
{
	...
	/*Check if Axis was enabled*/
	u8IsEnabled1 = u8CheckAxisIsEnabled(u8AxisMask3);
...
u8 GYHD_ReadZDirection(u16* pu16Data,u8* pu8ReadingStatus)
{
	u8 RetVar7 = NOK;
	u8 u8IsEnabled4=0;
	u8 u8AxisMask6 = u8NEW_DATA_AVAILABEL_Z_MASK;
	/*Check if Axis was enabled*/
	u8IsEnabled4 = u8CheckAxisIsEnabled(u8AxisMask6);
...
{
	u8 u8Status=0;
	L3G4200D_READ_STATUS_REG((u8*)&u8Status);
	/*Check for Data updated*/
...
{
	u8 u8RegData9=0;
	L3G4200D_READ_CTRL_REG5(&u8RegData9);
	u8RegData9 &= u8FILTERS_CLR_MASK;
	u8RegData9 |= (L3G4200D_ConfigParam.strFilterCfg.u8FilterOnData | L3G4200D_ConfigParam.strFilterCfg.u8FilterOnInterrupt);
	L3G4200D_WRITE_CTRL_REG5(u8RegData9);
}
/*****************************************************************************************************/
#if(u8SELF_AXIS_MOV == ON)
static void vidInitSelectiveAxisMovement(void)
{
	...
	u8RegData66 = (L3G4200D_ConfigParam.strIntCfg.u8XAxisInterrupt | L3G4200D_ConfigParam.strIntCfg.u8YAxisInterrupt | L3G4200D_ConfigParam.strIntCfg.u8ZAxisInterrupt);
	L3G4200D_WRITE_INT1_CFG(u8RegData66);
}
#endif
